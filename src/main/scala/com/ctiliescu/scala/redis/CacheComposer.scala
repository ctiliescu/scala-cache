...
object CacheComposer {
  ...
  def cache[A, B, C, D, R](func: (A, B, C, D) => R, a: A, b: B, c: C, d: D)(implicit en: Encoder[R], de: Decoder[R]): R = {
    new RedisService().optimiseOp(func(a, b, c, d), a, b, c, d)
  }

  def cache[A, B, C, D, E, R](func: (A, B, C, D, E) => R, a: A, b: B, c: C, d: D, e: E)(implicit en: Encoder[R], de: Decoder[R]): R = {
    new RedisService().optimiseOp(func(a, b, c, d, e), a, b, c, d, e)
  }

  def cache[A, B, C, D, F, G, R](func: (A, B, C, D, F, G) => R, a: A, b: B, c: C, d: D, e: F, f: G)(implicit en: Encoder[R], de: Decoder[R]): R = {
    new RedisService().optimiseOp(func(a, b, c, d, e, f), a, b, c, d, e, f)
  }

  def cache[A, B, C, D, F, G, H, R](func: (A, B, C, D, F, G, H) => R, a: A, b: B, c: C, d: D, e: F, f: G, h: H)(implicit en: Encoder[R], de: Decoder[R]): R = {
    new RedisService().optimiseOp(func(a, b, c, d, e, f, h), a, b, c, d, e, f, h)
  }

  def cache[A, B, C, D, F, G, H, I, R](func: (A, B, C, D, F, G, H, I) => R, a: A, b: B, c: C, d: D, e: F, f: G, h: H, i: I)(implicit en: Encoder[R], de: Decoder[R]): R = {
    new RedisService().optimiseOp(func(a, b, c, d, e, f, h, i), a, b, c, d, e, f, h, i)
  }

  def cache[A, B, C, D, F, G, H, I, J, R](func: (A, B, C, D, F, G, H, I, J) => R, a: A, b: B, c: C, d: D, e: F, f: G, h: H, i: I, j: J)(implicit en: Encoder[R], de: Decoder[R]): R = {
